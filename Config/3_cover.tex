...
\nttitle(main,en){Mapping an inventory of south/ peripheral concepts on Affects through an interactive Omeka platform development}%
...
%-------------------------------------------------------------------
\ntauthorname(f){Ana Carolina Batoque Gadelha}{Ana Carolina Gadelha}
